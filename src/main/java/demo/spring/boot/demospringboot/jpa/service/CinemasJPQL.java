package demo.spring.boot.demospringboot.jpa.service;//package com.springboot.service.jpa;
...
@Component
public interface CinemasJPQL extends CrudRepository<CinemasJsonVo, Integer> {
